        ...
        return (
            ...
            <div style={stylesSingleMessage.outerContainerReadFavourited}>
                ...
                <div style={stylesSingleMessage.buttonsContainer}>
                    <i style={stylesSingleMessage.readPressed} className="fab fa-readme" onClick={() => handleRead(id)}></i>
                    <i style={stylesSingleMessage.favouritePressed} className="fas fa-star" onClick={() => handleFavourite(id)}></i>
